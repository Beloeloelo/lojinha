...
export default function ProductoScreen6() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.title}>BLUSA CASUAL</Text>
      ...
      <View style={styles.optionsRow}>
        ...
        />
        <TouchableOpacity
          onPress={() => setSelectedColor('preto')}
          style={[styles.colorCircle, selectedColor === 'preto' && styles.selectedBorder, { backgroundColor: 'black' }]}
        />
        <TouchableOpacity
          onPress={() => setSelectedColor('vermelho')}
          style={[styles.colorCircle, selectedColor === 'vermelho' && styles.selectedBorder, { backgroundColor: 'red' }]}
        />
        <TouchableOpacity
          onPress={() => setSelectedColor('pink')}
          style={[styles.colorCircle, selectedColor === 'rosa-claro' && styles.selectedBorder, { backgroundColor: 'brown' }]}
        />
        <TouchableOpacity
          onPress={() => setSelectedColor('pink')}
