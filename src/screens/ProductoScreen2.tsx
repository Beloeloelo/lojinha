...
export default function ProductoScreen2 () {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.title}>VESTIDO FLORIDO</Text>
      <Text style={styles.price}>R$ 229,90</Text>

      <Text style={styles.section}>COR</Text>
      <View style={styles.optionsRow}>
        <TouchableOpacity
          onPress={() => setSelectedColor('branco')}
          style={[styles.colorCircle, selectedColor === 'branco' && styles.selectedBorder, { backgroundColor: 'branco' }]}
        />
        <TouchableOpacity
          onPress={() => setSelectedColor('pink')}
          style={[styles.colorCircle, selectedColor === 'rosa' && styles.selectedBorder, { backgroundColor: 'pink' }]}
        />
         <TouchableOpacity
