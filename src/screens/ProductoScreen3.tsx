...
export default function ProductoScreen3 () {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.title}>VESTIDO CASUAL</Text>
      <Text style={styles.price}>R$ 120,90</Text>
      ...
      <View style={styles.optionsRow}>
        ...
        <TouchableOpacity
          ...
          style={[styles.colorCircle, selectedColor === 'red' && styles.selectedBorder, { backgroundColor: 'red' }]}
        />
      </View>
