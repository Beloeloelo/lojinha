...
export default function ProductoScreen4() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.title}>CONJUNTO FORMAL ALFAIATARIA</Text>
      <Text style={styles.price}>R$ 349,90</Text>

      <Text style={styles.section}>COR</Text>
      <View style={styles.optionsRow}>
         <TouchableOpacity
          onPress={() => setSelectedColor('MARROM')}
          style={[styles.colorCircle, selectedColor === 'marrom' && styles.selectedBorder, { backgroundColor: 'brown' }]}
        />
        <TouchableOpacity
